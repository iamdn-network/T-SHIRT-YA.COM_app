...
============================================================
*/
;$(function(){$("#container-main input").click(function(){var c=$("#number").val();var a=$("input[name=code]:checked").val();if(!c){c="4580416901192"}var b={barWidth:"1",barHeight:"40",moduleSize:"5",bgColor:"",color:"",fontSize:"13",output:"css"};$("#view_barcode").barcode(c,a,b)})});
